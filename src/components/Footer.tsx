...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-ink text-brand-crm pt-14 pb-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden border-t-4 border-brand-pd">
      {/* Subtiele halftoon-textuur */}
      <div className="qlc-halftone absolute inset-0 opacity-[0.06] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-brand-crm/15 pb-12 mb-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="mt-1 font-stamp uppercase tracking-widest text-brand-gold text-sm border border-brand-crm/20 px-3 py-1.5 w-fit -rotate-1">
          ...
          {/* Kolom 2: navigatie */}
          <div className="flex flex-col gap-4">
            <h4 className="font-stamp text-xs tracking-[0.2em] text-brand-gold uppercase">
              Navigatie
            </h4>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 mt-1">
              ...
              >
                <div className="p-2 bg-brand-pd border border-brand-crm/20 rounded">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-brand-crm/50 font-stamp">
          ...
          <div className="flex gap-5 items-center">
            <span className="flex items-center gap-1">
              <Shield className="w-3.5 h-3.5 text-brand-gold" /> KVK geregistreerd
            </span>
            ...
            <span>
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="text-brand-tlbr hover:text-brand-gold transition-colors underline underline-offset-4"
              >
                Updreef
              </a>
            </span>
