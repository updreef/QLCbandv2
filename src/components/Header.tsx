...
import { Menu, X, Music, Calendar, BookOpen, Users, Info } from "lucide-react";
...
export default function Header() {
  ...
  const navLinks = [
    { label: "Home", href: "/", icon: Music },
    { label: "Optredens", href: "/optredens", icon: Calendar },
    { label: "Boek ons", href: "/boek-ons", icon: BookOpen },
    { label: "Over ons", href: "/over-ons", icon: Info },
    { label: "Mannen", href: "/mannen", icon: Users },
    { label: "Muziek", href: "/muziek", icon: Music },
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <Link
          ...
          className="group inline-flex font-display text-2xl md:text-3xl tracking-widest text-brand-cream"
        >
      ...
      {/* Mobile Menu Panel */}
      {isOpen && (
        <div className="lg:hidden fixed inset-0 top-[68px] bg-brand-bg-3/98 z-40 border-t-3 border-brand-red p-6">
